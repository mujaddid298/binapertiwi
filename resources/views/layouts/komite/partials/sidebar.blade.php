...
<nav class="pc-sidebar">
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="{{ route('komite.home') }}" class="b-brand">
        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                <li class="pc-item">
                    <a href="{{ route('komite.home') }}" class="pc-link">
          ...
          <i class="ti ti-dashboard"></i>
                ...
                <li class="pc-item">
                    <a href="{{ route('komite.meeting.index') }}" class="pc-link">
                        <span class="pc-micon"><i class="ti ti-users"></i></span>
                        <span class="pc-mtext">Notifikasi</span>
                    </a>
                </li>
                <li class="pc-item">
                    <a href="{{ route('komite.datacustomer') }}" class="pc-link">
...
<!-- [ Sidebar Menu ] end -->
<!-- [ Header ]-->
@include('layouts.komite.partials.header')