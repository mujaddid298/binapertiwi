    ...
    <div class="col-sm-12">
      <div class="row">
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card">  
            <div class="card-body">
              ...
              <p class="mb-0 text-muted text-sm">Perkembangan <span class="text-success">8,900</span> hari ini</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-0 text-muted text-sm"> Perkembangan <span class="text-warning">1,943</span> hari ini</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              ...
              <h4 class="mb-3">35,078 <span class="badge bg-light-danger border border-danger"><i
                    class="ti ti-trending-up"></i> 27.4%</span></h4>
              <p class="mb-0 text-muted text-sm">Perkembangan <span class="text-danger">20,395</span> hari ini
              </p>
            </div>
          </div>
        </div>
        ...
        <div class=" text-right">
          <a href="{{ route('admin.persetujuan3') }}" class="btn btn-green mr-1 btn-a" style="float: left;">Tambah Nota Kredit</a>
        </div>
          ...
          <div class="table-responsive mb-4">
            <table class="table table-bordered table-striped" id="arTable">
              <thead class="bg-light">
                <tr>
                  <th class="sortable" onclick="sortTable(0)">Sales Organization <i class="ti ti-arrows-sort"></i></th>
                  <th class="sortable" onclick="sortTable(1)">Current <i class="ti ti-arrows-sort"></i></th>
                  <th class="sortable" onclick="sortTable(2)">1-30 Days <i class="ti ti-arrows-sort"></i></th>
                  <th class="sortable" onclick="sortTable(3)">31-60 Days <i class="ti ti-arrows-sort"></i></th>
                  <th class="sortable" onclick="sortTable(4)">61-90 Days <i class="ti ti-arrows-sort"></i></th>
                  <th class="sortable" onclick="sortTable(5)">91-120 Days <i class="ti ti-arrows-sort"></i></th>
                </tr>
              </thead>    
              <tbody>
                <tr>
