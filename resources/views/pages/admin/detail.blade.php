        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.form_openblock') }}" class="btn btn-danger w-100">Open Blok</a>
                    <br>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-8">
                <div class="card mt-6">
                    <div class="card-body">
                        ...
                        <p><strong>Prediksi Bulan Ini:</strong> Pembelian Pada bulan ini berpotensi akan naik sebanyak <span>600Jt</span>.</p>
            ...
            <div class="col-md-4">
                <div class="card mt-6">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <ul>
                                <li>Customer ini telat membayar Aging AR diatas 30 hari, telah melewati batas waktu yang ditentukan untuk melakukan pembayaran.</li>
                                <li>PKPS tersisi <span class="text-danger">20 hari</span> masa berlakunya. Silakan sarankan untuk melakukan perpanjang untuk menghindari customer terblokir.</li>
