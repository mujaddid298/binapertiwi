...
<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.storeformnak') }}" method="POST">
                    ...
                    <h5 class="text-center"> FASILITAS YANG DIMILIKI ( TERMASUK  KANTOR,  PABRIK,  JUMLAH PEGAWAI, DLL )</h5>
                    <div class="row mb-3">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table">
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="3">
                                            <button type="button" class="btn btn-green" onclick="addLembagaRow()">Tambah Baris</button>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
                        ...
                        <div class="col-md-12">
                            <table class="table">
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="3">
                                            <button type="button" class="btn btn-green" onclick="addReputasiRow()">Tambah Baris</button>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
                    ...
                    <h4 class="mt-4">KOMENTAR TRANSAKSI PEMBELIAN DAN HUBUNGAN DAGANG DENGAN PT. BINA PERTIWI SEBELUMNYA</h4>
                    <hr>
                    <div class="form-group">
                        <label for="komentar">Komentar</label>
                        <textarea class="form-control" id="komentar" name="komentar" rows="4" placeholder="Masukkan komentar mengenai transaksi pembelian dan hubungan dagang"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="baik" name="pengalaman_pembayaran" value="Baik">
                            <label class="form-check-label" for="baik">
                                Baik
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="sedang" name="pengalaman_pembayaran" value="Sedang">
                            <label class="form-check-label" for="sedang">
                                Sedang
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="tidak_baik" name="pengalaman_pembayaran" value="Tidak Baik">
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table">
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="5">
                                            <button type="button" class="btn btn-green" onclick="addSukuCadangRow()">Tambah Baris</button>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="kondisi_isu_makro" name="kondisi_isu_makro" rows="4" placeholder="Masukkan deskripsi mengenai kondisi dan isu-isu makro"></textarea>
                    </div>
                    <h4 class="mt-4">KOMENTAR DARI BC</h4>
                    <hr>
                    <div class="form-group">
                        <label for="komentar_bc">Komentar</label>
                        <textarea class="form-control" id="komentar_bc" name="komentar_bc" rows="4" placeholder="Masukkan komentar dari BC"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="akte_pendirian" name="lampiran[]" value="Akte Pendirian">
                            <label class="form-check-label" for="akte_pendirian">Akte Pendirian</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="cash_flow" name="lampiran[]" value="Cash Flow">
                            <label class="form-check-label" for="cash_flow">Cash Flow</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="neraca_dan_rugi_laba" name="lampiran[]" value="Neraca & Daftar Rugi Laba">
                            <label class="form-check-label" for="neraca_dan_rugi_laba">Neraca & Daftar Rugi Laba</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="kontrak_spk" name="lampiran[]" value="Kontrak / SPK">
                            <label class="form-check-label" for="kontrak_spk">Kontrak / SPK</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="siup_situ" name="lampiran[]" value="SIUP/SITU">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="npwp_skt_sppkp" name="lampiran[]" value="NPWP, SKT, SPPKP">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="rekening_koran" name="lampiran[]" value="Rekening Koran">
                            <label class="form-check-label" for="rekening_koran">Rekening Koran</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="bank_garansi" name="lampiran[]" value="Bank Garansi">
                            <label class="form-check-label" for="bank_garansi">Bank Garansi</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="skdp_sktu" name="lampiran[]" value="SKDP/SKTU">
                            <label class="form-check-label" for="skdp_sktu">SKDP/SKTU</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="lain_lain" name="lampiran[]" value="Lain-lain">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="disetujui" name="komite_kredit" value="Disetujui">
                            <label class="form-check-label" for="disetujui">Disetujui</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="disetujui_dengan_syarat" name="komite_kredit" value="Disetujui dengan Syarat">
                            <label class="form-check-label" for="disetujui_dengan_syarat">Disetujui dengan Syarat (Lihat Notulen Rapat)</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="ditolak" name="komite_kredit" value="Ditolak">
                    ...
                    <div class="form-group">
                        ...
                        <p id="komentar_direktur_sales_operation">Contoh komentar dari DIREKTUR SALES AND OPERATION.</p>
                    </div>

                    <div class="form-group">
                        <label for="komentar_admin_support_head">Komentar ADMIN AND SUPPORT DIVISION HEAD</label>
                        <p id="komentar_admin_support_head">Contoh komentar dari ADMIN AND SUPPORT DIVISION HEAD.</p>
                    </div>

                    <div class="form-group">
                        <label for="komentar_sales_operation_head">Komentar SALES AND OPERATION DIVISION HEAD</label>
                        <p id="komentar_sales_operation_head">Contoh komentar dari SALES AND OPERATION DIVISION HEAD.</p>
                    </div>
  ...
  <h4 class="mt-4"> PERSETUJUAN</h4>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td><img src="path/to/default-signature.png" alt="Tanda Tangan DIREKTUR ADMIN & SUPPORT" style="width: 100px; height: auto;"></td>
                                <td><img src="path/to/default-signature.png" alt="Tanda Tangan DIREKTUR SALES & OPERATION" style="width: 100px; height: auto;"></td>
                                <td><img src="path/to/default-signature.png" alt="Tanda Tangan ADM & SUPP DIV HD" style="width: 100px; height: auto;"></td>
                                <td><img src="path/to/default-signature.png" alt="Tanda Tangan SALES & OPT DIV HD" style="width: 100px; height: auto;"></td>
                            </tr>
                        </tbody>
                    </table>
