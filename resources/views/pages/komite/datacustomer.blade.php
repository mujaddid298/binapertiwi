    ...
    <div class="page-block">
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('komite.datacustomer') }}">Daftar Pelanggan</a></li>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                        style="border: none; background: none; font-size: 1.5rem; color: #000;">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('komite.uploadExcel') }}" method="POST" enctype="multipart/form-data">
                        @csrf
