            ...
            <div class="card-body">
                <form action="{{ route('admin.storeformnak') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <h6 class="text-center"> FASILITAS YANG DIMILIKI ( TERMASUK KANTOR, PABRIK, JUMLAH PEGAWAI, DLL
                            )</h6>
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <table class="table">
                                    ...
                                    <tbody id="jumlah-fasilitas">
                                        <tr>
                                            ...
                                            <td><input type="number" class="form-control" name="jumlah_fasilitas[]">
                                            </td>
                                            <td><input type="text" class="form-control" name="keterangan_fasilitas[]">
                                            </td>
                                            <td><button type="button" class="btn btn-danger"
                                                    onclick="removeRow(this)">Hapus</button></td>
                                        </tr>
